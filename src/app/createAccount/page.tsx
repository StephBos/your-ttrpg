    ...
    <div className="font-sans grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20 relative overflow-hidden">
      ...
      <main className="flex flex-col row-start-2 items-center sm:items-start bg-gray-900/90 p-6 rounded gap-2 relative z-10">      
        <form action="submit" className="flex flex-col gap-2">
            ...
            <input type="text" name="username" className="bg-gray-800 rounded p-1 w-64" placeholder="Username" onChange={e => checkIfUsernameExists(e.target.value).then((exists: boolean) => setUsernameExists(exists))}/>
            ...
            <button className="bg-indigo-950 hover:bg-indigo-900 w-64 rounded" disabled={buttonDisabled}>Create Account</button>
